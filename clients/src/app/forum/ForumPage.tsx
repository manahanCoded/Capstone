                ...
                >
                  ...
                  <div className="flex justify-end border-t-[1px] pt-4 gap-2 mt-4">
                    {checkAdmin?.role === "admin" && (
                      <Link
                        href={`/forum/edit-Job/${job.id}`}
                        className="lg:text-sm text-xs py-2 px-4 rounded-lg border-2 border-black hover:bg-black hover:text-white"
                      >
                        Edit
                      </Link>
                    )}
                    <Link
                      href={`/forum/check-job/${job.id}`}
                      className="lg:text-sm text-xs py-2 px-4 rounded-lg bg-black text-white hover:bg-opacity-90"
                    >
                      Checkout
                    </Link>
                  </div>
